# Adapted from https://github.com/md4all/md4all/blob/main/train.py
import os
import socket
import time
...
def train():
    ...
    model = ACDepth(cfg, is_train=True)
    ...
    checkpoint_callback = ModelCheckpoint(monitor=cfg.SAVE.MONITOR, save_last=cfg.SAVE.LAST, save_top_k=cfg.SAVE.TOP_K, mode=cfg.SAVE.MODE, dirpath=cfg.SAVE.CHECKPOINT_PATH, filename=cfg.EXPERIMENT_NAME + '-{epoch:02d}')
