...
if __name__ == '__main__':
    ...
    dataroot = '/data_share/jing/jing/pythons/datasets/robotcar/dataset/'
    scenes = ['2014-12-16-18-44-24']
    camera_sensor = 'stereo/left'
    out_dir = '/data_share/jing/jing/pythons/datasets/robotcar/dataset/image'
