...
class RobotCarDataset:
    ...
    def get_color(self, frame_idx, camera_sensor, temp):
        ...
        return Image.open(filepath).convert("RGB"), filename
...
class RobotCarDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        crop = data.transforms.Crop(top=self.dataset_crop_top, left=self.dataset_crop_left,
                                    ...
                                    sample_keys=['color', 'color_aug', 'color_aug_pose', 'K', 'depth_gt','color_original'], temp_context=self.temp_context)
        ...
        robotcar_subset_test = RobotCarDataSubset(robotcar_dataset=robotcar_dataset, mode='test')
