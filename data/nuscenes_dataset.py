# Adapted from https://github.com/md4all/md4all/blob/main/data/nuscenes_dataset.py
import logging
import os
import json
...
class NuScenesDataModule(pl.LightningDataModule):
    ...
    def val_dataloader(self):
        if self.isdist:
            ...
            val_loader = DataLoader(dataset=self.val_dataset, batch_size=self.val_batch_size, sampler=sampler,
    ...
    def test_dataloader(self):
        if self.isdist:
            ...
            test_loader = DataLoader(dataset=self.eval_dataset, batch_size=self.eval_batch_size, sampler=sampler,
                                    num_workers=self.num_workers, pin_memory=False, drop_last=False)
        else:
